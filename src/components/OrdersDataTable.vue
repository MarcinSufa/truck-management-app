...
<template>
  <Toast />
  <DataTable v-model:filters="filters" v-model:selection="selectedOrder" selectionMode="single" :value="orders" tableStyle="min-width: 50rem;"
  ...
  >
    ...
    <Column field="label" header="Type" sortable style="width: 22%">
      <template #body="slotProps">
        <div class="flex items-center">
          <Tag :value="slotProps.data.orderData.orderType" />
        </div>
      </template>
    </Column>
